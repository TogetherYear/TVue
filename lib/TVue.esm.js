...
const publicPropertiesMap = {
    ...
    $props: (instance) => instance.vNode.props
};
...
const ShouldUpdateComponent = (prevVNode, vNode) => {
...
const CreateRenderer = (options) => {
    ...
    const UpdateComponent = (prevVNode, vNode, container, parentComponent, anchor) => {
...
export { CreateApp, CreateRenderer, CreateTextVNode, Effect, GetCurrentInstance, H, Inject, NextTick, Provide, ProxyRefs, Reactive, Ref, RenderSlots };
