...
const CreateRenderer = (options) => {
    ...
    const PatchElement = (prevVNode, vNode, container, parentComponent) => {
        const el = vNode.el = prevVNode.el;
        PatchChildren(el, prevVNode, vNode, parentComponent);
    ...
    const PatchChildren = (el, prevVNode, vNode, parentComponent) => {
...
export { CreateApp, CreateRenderer, CreateTextVNode, Effect, GetCurrentInstance, H, Inject, Provide, ProxyRefs, Reactive, Ref, RenderSlots };
